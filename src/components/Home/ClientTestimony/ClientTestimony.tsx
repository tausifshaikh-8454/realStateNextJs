...
export default function ClientTestimony() {
  return (
    <>
      <div className="max-w-360 w-full flex flex-row justify-center m-auto px-10 py-25 bg-[#1A1A1A] gap-30">
        <div className="w-[50%]">
      ...
      <div className="max-w-360 w-full border-t-1 border-white bg-[#1A1A1A] px-10 py-25">
        <div className="inline-block">
          <img src={testiImg.src} alt="Testimonial" />
          <img src={testiImg.src} alt="Testimonial" />
          <img src={testiImg.src} alt="Testimonial" />
          <img src={testiImg.src} alt="Testimonial" />
          <img src={testiImg.src} alt="Testimonial" />
